...
# Load pre-trained Deformable DETR model
model = DeformableDETR(num_classes=91)  # COCO classes
checkpoint = torch.load('path/to/deformable_detr_checkpoint.pth', map_location=)
